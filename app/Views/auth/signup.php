    ...
    <div class="w-full mx-44 rounded-lg bg-white p-8 flex justify-between shadow-xl">
        ...
        <div class="h-[32rem] w-[25rem] animate-fadeLeft opacity-0">
            ...
            <form method="POST" class="space-y-4 mt-9 pl-7 animate-fadeUp opacity-0">
                ...
                <!-- Bouton -->
                <button type="submit"
                    class="w-full bg-gray-900 text-white py-2 rounded-lg hover:bg-white hover:outline hover:outline-2 hover:text-gray-900 hover:outline-gray-900 transition-colors font-semibold">
                    S'inscrire
                </button>
            </form>
