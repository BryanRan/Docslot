...
<body>
    <!-- Splash Screen -->
    <div id="splash"
        class="fixed inset-0 flex flex-col items-center justify-center bg-white z-[9999] transition-opacity duration-700">
        <img src="<?= base_url('img/Logo 1.png') ?>" alt="Logo" class="h-20 w-20 animate-bounce mb-6">
        <h1 class="text-3xl font-bold text-dark-green">DOCSLOT</h1>
        <p class="text-gray-500 mt-2">Chargement...</p>
    </div>
    <!-- Header -->
    <div id="land" class="opacity-0 transition-opacity duration-700">
    ...
    <script>
        window.addEventListener("load", () => {
            ...
            const body = document.getElementById("land");

            // Attendre un petit délai avant de masquer le splash
            setTimeout(() => {
                splash.classList.add("opacity-0");
                body.classList.remove("opacity-0");

                // Retirer le splash après l’animation
                setTimeout(() => {
